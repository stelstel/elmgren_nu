...
//		);
		...
		foreach($filters as $func) {
			if(isset($this->valid[$func])) {
				$temp = $this->valid[$func];
				$text = $this->$temp($text);
			} 
			else {
	...
	function markdown($text) {
		require_once('../webroot/php-markdown/Michelf/MarkdownInterface.php');
		require_once('../webroot//php-markdown/Michelf/Markdown.php');
		require_once('../webroot//php-markdown/Michelf/MarkdownExtra.php');
