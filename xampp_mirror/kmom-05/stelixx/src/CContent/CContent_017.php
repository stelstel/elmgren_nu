...
EOD;
	...
	//****************************************************************************************
	public function showUpdateForm($slug, $servQuery){
		if(isset($servQuery) AND strlen($servQuery) > 0){
...
EOD;
		...
		$output .= '<p><label for="txtSlug">Slug:<br /></label><input type="text" name="txtSlug" id="txtSlug" value="' . $slug . '"/></p>';
		$output .= '<p><label for="txtURL">URL:<br /></label><input type="text" name="txtURL" id="txtURL" value="' . $result[0]->url . '"/></p>';
		...
		$output .= '<p><label for="txtType">Type:<br /></label><input type="text" name="txtType" id="txtType" value="' . $result[0]->TYPE . '"/></p>';
