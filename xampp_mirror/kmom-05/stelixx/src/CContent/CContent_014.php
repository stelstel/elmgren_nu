...
EOD;
	...
	public function addPostOrPage($req){
		...
		$sqlInsert .= "VALUES ( " . strip_tags($id) . ",'" . $slug;
		...
		$sqlInsert .=  $type . "','" . $title . "','" . $fieldText . "','" . $filter . "','" . $publDate . "','" . $createDate . "')";
		//TEST IF INSERT WORKED
		return $sqlInsert; ////////////////////////////////////////////////////////
		}
	}
}