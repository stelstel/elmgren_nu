...
EOD;
	...
	public function createPage() {
		echo "111: " . strlen($this->requestURI) . "<br>"; /////////////////////////////////////////////////////
		echo "222: " . strpos($this->requestURI, "?") . "<br>"; /////////////////////////////////////////////////////
	...
	private function putPageLinks($qry, $rowL, $tRows){
		...
		$URLWithoutPage = $this->removeKeyVal($_SERVER["REQUEST_URI"], "&page=" );
	...
	private function putHits($qu){
		...
		if(strlen($qu) <= 0 AND strpos($this->requestURI, "?")){
			$questionmark = "?"; // Put question mark if needed
		}
		
		
		$URLWithoutHits = $this->removeKeyVal($_SERVER["REQUEST_URI"],"&hits=" );		
	...
	// 2014-10-22 23:51
	private function tableHeader(){
		$URLWithoutSort = $this->removeKeyVal($URIRequest, "order=" );
