...
EOD;
	...
	public function createTable($dbas, $query) {
		...
		if(strpos($_SERVER["REQUEST_URI"], "order=") > -1 ){
			...
			// Remove the sort key/value from URL
		...
		$table .= "<th scope='col'><a href=" . $URLWithoutSort . "?order=title>Titel</a></th>";
		$table .= "<th scope='col'><a href=" . $URLWithoutSort . "?order=YEAR>År</a></th>";
