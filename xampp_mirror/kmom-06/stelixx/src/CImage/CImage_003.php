...
class CImage {
	...
	private function init(){
		...
		define('CACHE_PATH', __DIR__ . DIRECTORY_SEPARATOR . '../../webroot/img/cimage/cache');
	...
	function errorMessage($message) {
		...
		die('CIamge.php says 404 - ' . htmlentities($message));
	}
...
EOD;
	...
	private function createFileName(){	
		...
		if(!$this->ignoreCache && is_file($cacheFileName) && $imageModifiedTime < $cacheModifiedTime) {
			...
			outputImage($cacheFileName, $this->verbose);
		}
