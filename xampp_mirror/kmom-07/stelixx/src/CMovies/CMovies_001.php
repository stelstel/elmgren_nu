...
EOD;
		...
		$output .= $result[0]->plot . '</textarea></p>';
		$output .= '<p><label for="txtÅr">År:<br /></label><input type="text" name="txtYear" id="txtYear" value="' . $result[0]->YEAR . '"/></p>';
		$output .= '<p><label for="txtPris">Pris:<br /></label><input type="text" name="txtPris" id="txtPris" value="' . $result[0]->price . '"/></p>';
