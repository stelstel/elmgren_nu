...
EOD;
		...
		$output .= '<p><label for="txtSmallImg">Omslagsbild:<br /></label><input type="text" name="txtSmallImg" id="txtSmallImg" value="' . $posterImg . '"/></p>';
		...
		$output .= '<p><label for="txtBigImg">Bild:<br /></label><input type="text" name="txtBigImg" id="txtBigImg" value="' . $bigImg . '"/></p>';
  	...
  	$output .= '<input type="reset" name="btnReset" id="button" value="Återställ" />';
		...
		$output .= '<p class="centeredImage"><img src="' . $imgURL . '"/></p>';
		*/
