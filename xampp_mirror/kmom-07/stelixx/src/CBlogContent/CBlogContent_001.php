...
EOD;
	...
	public function show($request, $part){
		...
		//$summaryLength = 200; // Summary text length
...
//		}else 
		...
		//debu("pageOrBlog", $pageOrBlog); //////////////////////////////////////////////////////
//		debu("slug", $slug ); //////////////////////////////////////////////////////
//		if(strcmp ( $pageOrBlog , "blog" ) == 0 AND !isset($request["slug"] ) ){
//		//if($pageOrBlog <> "blog"){ //Shorten text when showing summary
//			$result = substr ( $result , 0 , $summaryLength);
//		}
